...
function CaseVisual({ kind }: { kind: VisualKind }) {
  if (kind === 'type') return <div className="case-visual visual-type-original"><img className="visual-composite" src={asset('type-goal-original.png')} alt="Четыре типа копилки" draggable="false" loading="lazy" /></div>;
