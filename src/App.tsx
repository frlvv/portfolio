...
export default function App() {
  ...
  return <><a className="skip-link" href="#work">К работам</a><main className="portfolio-layout" data-case-open={caseOpen}>
    <aside className="profile"><div className="profile-block"><p className="eyebrow">Влад Фролов</p><h1>Продуктовый дизайнер</h1></div><div className="profile-block"><p className="eyebrow">Опыт</p><p>Проектирую мобильные приложения, Telegram Mini Apps и&nbsp;игровые лаунчеры на&nbsp;фрилансе, в&nbsp;том числе для&nbsp;постоянных клиентов.<br />Работал над&nbsp;внутренним сервисом учёта нагрузки сотрудников и&nbsp;затрат по&nbsp;проектам во&nbsp;время стажировки.</p></div><div className="profile-block"><p className="eyebrow">Скиллы</p><p>research, user flows, wireframing, prototyping, usability testing, design systems, edge cases, animation, lottie, handoff, design review</p></div><div className="profile-actions">
